...
CREATE OR REPLACE FUNCTION transportation.refresh() RETURNS trigger AS
  ...
  BEGIN
    ...
    -- REFRESH MATERIALIZED VIEW CONCURRENTLY osm_transportation_merge_linestring_gen3;
    -- REFRESH MATERIALIZED VIEW CONCURRENTLY osm_transportation_merge_linestring_gen4;
    -- REFRESH MATERIALIZED VIEW CONCURRENTLY osm_transportation_merge_linestring_gen5;
    -- REFRESH MATERIALIZED VIEW CONCURRENTLY osm_transportation_merge_linestring_gen6;
    -- REFRESH MATERIALIZED VIEW CONCURRENTLY osm_transportation_merge_linestring_gen7;
